...
//Still a bit confused on arrays, but it's more on how to write them...
        ...
        */
        ...
        test("A canceled change doesn't persist", async () => {
            ...
            */
            ...
            await driver.findElement(nameInput).clear();
            await driver.findElement(nameInput).sendKeys("Pizza Steve");
...
/* most stuff makes sense in the methodology,
I think I'm still just learning the code "lingo"...
and when and where to use specific characters to wirte i.e..() {}[] == === etc... *./
        ...
        test("A saved change persists", async () => {
            ...
            */
            ...
            await driver.findElement(nameInput).clear();
            await driver.findElement(nameInput).sendKeys("Cousin Vinny");
...
/*All the tests made sense, it was clear to see what it was asking for and what it was doing, like "await driver.findElement"...
the web driver crawls to find the defined element (Bernice) then clicks on it, 
I guess I'm just hung up on the writing and terminology, and maybe it's not supposed to make complete sense yet and...
